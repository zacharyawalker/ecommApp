...
//     try {
//       await axios.post('http://localhost:8000/api/v1/designs/', formData, {
//         headers: {
...
// import { useState } from 'react';
// import { TextField, Button, Box, Typography, IconButton, Modal, LinearProgress, Alert } from '@mui/material';
// import axios from 'axios';
// import CloseIcon from '@mui/icons-material/Close';
