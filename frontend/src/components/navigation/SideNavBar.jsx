...
// import AuthAxios from "../../../../../theone_old/frontend/src/components/axios/AuthAxios.jsx";
...
//   const toggleMockupsMenu = () => {
//     setMockupsOpen(!mockupsOpen);
//   };

//   const handleMockupsClick = () => {
//     navigate('/mockups/all'); // Navigate to "All" under Mockups
//     setMockupsOpen(!mockupsOpen); // Toggle submenu visibility
//   };
...
//                     <ImageIcon />
//                   </ListItemIcon>
//                   {!collapsed && <span className={styles.sideBarLink}>Designs</span>}
//                 </ListItemButton>
//               </Tooltip>
//             </ListItem>
//             <ListItem key={3} disablePadding>
//               <Tooltip title={collapsed ? 'Mockups' : ''} placement="right">
//                 <ListItemButton onClick={handleMockupsClick}>
//                   <ListItemIcon>
//                     <InfoIcon />
//                   </ListItemIcon>
//                   {!collapsed && (
...
//                       {mockupsOpen ? <ExpandLessIcon /> : <ExpandMoreIcon />}
//                     </>
//                   )}
//                 </ListItemButton>
//               </Tooltip>
...
//             {mockupsOpen && !collapsed && (
//               <Box sx={{ pl: 4 }}>
//                 <ListItem disablePadding>
//                   <ListItemButton component={Link} to="/mockups/all" selected={'/mockups/all' === path}>
//                     <ListItemIcon />
//                     <span className={styles.sideBarLink}>All</span>
//                   </ListItemButton>
//                 </ListItem>
//                 <ListItem disablePadding>
//                   <ListItemButton component={Link} to="/create-mockup" selected={'/mockups/new' === path}>
//                     <ListItemIcon />
//                     <span className={styles.sideBarLink}>New</span>
//                   </ListItemButton>
//                 </ListItem>
//                 <ListItem disablePadding>
//                   <ListItemButton component={Link} to="/mockup-library" selected={'/mockups/my-libraries' === path}>
//                     <ListItemIcon />
//                     <span className={styles.sideBarLink}>My Libraries</span>
//                   </ListItemButton>
//                 </ListItem>
//               </Box>
//             )}
...
//             <ListItem key={3} disablePadding>
//               <Tooltip title={collapsed ? 'Sandbox' : ''} placement="right">
//                 <ListItemButton
//                   component={Link}
//                   to="/sandbox"
...
//                     <PsychologyAltIcon />
//                   </ListItemIcon>
//                   {!collapsed && <span className={styles.sideBarLink}>Sandbox</span>}
//                 </ListItemButton>
//               </Tooltip>
//             </ListItem>
//           </List>
...
export default function SideNavBar(props) {
  ...
  const handleLogout = async () => {
    try {
      ...
      await axios.post('http://api/v1/auth/logout/', { refresh: refreshToken });
      localStorage.removeItem('access');
      localStorage.removeItem('refresh');
      sessionStorage.removeItem('access');
      sessionStorage.removeItem('refresh');
